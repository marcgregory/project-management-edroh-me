    ...
    <div className={sidebarClassName}>
      <div className="flex h-full w-full flex-col justify-start">
        ...
        <div className="flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700">
          <Image
            src="https://pm-s3-imagesme.s3.ap-southeast-1.amazonaws.com/logo.png"
            alt="Logo"
            loading="eager"
            width={40}
            height={40}
        ...
        <div className="flex w-full items-center">
          <div className="align-center flex h-9 w-9 justify-center">
            {!!currentUserDetails?.profilePictureUrl ? (
              <Image
                src={`https://pm-s3-imagesme.s3.ap-southeast-1.amazonaws.com/${currentUserDetails?.profilePictureUrl}`}
...
const SidebarLink = ({ href, icon: Icon, label }: SidebarLinkProps) => {
  ...
  return (
    <Link href={href} className="w-full">
      ...
      >
        {isActive && (
          <div className="height absolute top-0 left-0 h-full w-1.25 bg-blue-200" />
        )}

        <Icon className="size-6 text-gray-800 dark:text-gray-100" />
        <span className={cn("font-medium text-gray-800 dark:text-gray-100")}>
          {label}
        </span>
      </div>
    </Link>
