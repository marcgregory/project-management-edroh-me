      ...
      <div className="grid grid-cols-1 gap-4 p-4 md:grid-cols-2 xl:grid-cols-4">
        {taskStatus.map((status) => (
          <TaskColumn
            ...
            tasks={tasks || []}
            moveTask={moveTask}
            setIsModalNewTasksOpen={setIsModalNewTaskOpen}
          />
        ))}
      </div>
    </DndProvider>
...
type TaskColumnProps = {
  ...
  setIsModalNewTasksOpen: (isOpen: boolean) => void;
};
...
const TaskColumn = ({
  ...
  return (
    <div
      ...
      className={cn("rounded-lg py-2 sm:py-4 xl:px-2", {
        "bg-blue-100 dark:bg-neutral-950": isOver,
      })}
    >
      <div className="mb-3 flex w-full">
        <div
          className={`!bg-[${statusColor[status]}] w-2 rounded-s-lg`}
        ...
        <div className="dark:bg-dark-secondary flex w-full items-center justify-between rounded-e-lg bg-white px-5 py-4">
          ...
          <div className="flex items-center gap-1">
            <button className="flex h-6 w-5 cursor-pointer items-center justify-center dark:text-neutral-500">
              <EllipsisVertical size={26} />
            </button>
            <button
              onClick={() => setIsModalNewTasksOpen(true)}
              className="dark:bg-dark-tertiary flex size-6 cursor-pointer items-center justify-center rounded bg-gray-200 dark:text-white"
            >
              <Plus size={16} />
            </button>
          </div>
...
const Task = ({ task }: TaskProps) => {
  ...
  return (
    <div
      ...
      className={cn(
        "dark:bg-dark-secondary mb-4 rounded-md bg-white opacity-100 shadow",
        {
    ...
    >
      ...
      <div className="p-4 md:p-6">
        ...
        <div className="dark-bor dark:border-stroke-dark mt-4 border-t border-gray-200">
